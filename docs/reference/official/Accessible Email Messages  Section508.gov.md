---
created: 2026-04-26T13:16:49 (UTC -05:00)
tags: []
source: https://www.section508.gov/create/email-messages/
author: Authoring Guides
---

# Accessible Email Messages | Section508.gov

> ## Excerpt
> Learn how to create accessible email messages—including Microsoft Outlook documents, that conform to the Section 508 Standards.Creating Accessible Email MessagesEmail is a vital communication tool for

---
Learn how to create accessible email messages—including Microsoft Outlook documents, that conform to the [Section 508 Standards](https://www.access-board.gov/ict/).

## Creating Accessible Email Messages

Email is a vital communication tool for federal employees to transmit [agency official communication](https://www.section508.gov/tools/glossary/#agency-official-communications). To ensure all federal employees have access to information contained within and attached to email messages, we must ensure the emails meet Section 508 Standards. Below are easy steps to create accessible email messages so all individuals, including those with disabilities, can easily read, understand, and interact with the content.

It’s important to note that modern email software increasingly offers users the ability to format messages using styles and tools similar to those found in document authoring tools. For example, Microsoft Outlook offers an HTML format similar to Word. Some email messages use plain text format and do not allow for images or other design features, therefore the tips outlined in this guidance may not apply in all circumstances.

### Step 1: Write your email

The subject and body of email messages should clearly and concisely state the purpose of the message. The author should use [plain language](https://www.plainlanguage.gov/) appropriate for the intended audience.
...
Plain language improves accessibility and works with whatever style you follow. Below is a summary of the [Digital.gov Style Guide](https://digital.gov/style-guide/) and [18F Style Guide](https://guides.18f.gov/content-guide/our-style/) used at the General Services Administration (GSA); they are similar to many of the [federal government style guides](https://www.plainlanguage.gov/resources/guides/) and other writing guidelines available on [plainlanguage.gov](http://www.plainlanguage.gov/). These guidelines show employees how to write electronic content such as email messages, documents, and web pages.
...
-   [Active voice](https://guides.18f.gov/content-guide/our-style/active-voice/) - Our writing should be concise and direct. We prefer the active voice because it supports brevity and makes written content more engaging.
...
-   [Inclusive language](https://guides.18f.gov/content-guide/our-style/inclusive-language/) - The words we use make the difference between forging positive connections and creating distance in our personal and professional lives.
...
-   [Numbers, percentages, and dates](https://guides.18f.gov/content-guide/our-style/numbers-and-percentages/) - In body copy, spell out numbers one through nine and use numerals for numbers 10 and greater.
...
-   [Specific words and phrases](https://guides.18f.gov/content-guide/our-style/specific-words-and-phrases/) - As with other style rules, we use rules for the accepted forms of common words and phrases for capitalization, hyphenation, and punctuation.
-   [Technical writing](https://guides.18f.gov/content-guide/our-style/technical-and-interface-writing/) - In most cases, it’s safe to say the reader is learning something new or troubleshooting, therefore you need to write clear, concise instructions for the best possible experience.
...
-   [URLs and filenames](https://webaim.org/techniques/hypertext/#link_to_link) - It’s important to remember users of screen readers will often [skip from one link to another](https://webaim.org/techniques/hypertext/#link_to_link), skipping the text in between, as a way of skimming for the content they need. For filenames, use hyphens to separate words, just as with URLs. Lowercase filenames are better because it’s easier to type and to remember.
-   [Voice and tone](https://guides.18f.gov/content-guide/our-style/voice-and-tone/) - Our voice is our unique personality. You should think of your written voice as analogous to your actual tone of voice. Tone is more like attitude—the emotional context of a piece.
...
The Accessibility Checker helps create accessible emails by identifying potential issues for people with disabilities in reading content or using the document. Regardless of the recipient, all failures must be remediated before sending the email. If you generate a great deal of email, you may want to add the “Check Accessibility” button to the main authoring ribbon or [quick tools](https://support.office.com/en-us/article/customize-the-ribbon-in-office-00f24ca7-6021-48d3-9514-a31a460ecb31) section.

![Outlook application message interface with arrows highlighting instructions 1 and 2 described below.](https://www.section508.gov/assets/images/create-email-figure-1.jpg)

**Figure 1.** Screenshot of the Outlook application message interface.
...
![Outlook online message interface with arrows highlighting instructions 1 and 2 described below.](https://www.section508.gov/assets/images/create-email-figure-2.jpg)

**Figure 2.** Screenshot of the Outlook online message interface.
...
-   [Using Color | U.S. Web Design System (USWDS)](https://designsystem.digital.gov/design-tokens/color/overview/)
-   [WebAIM: Color Contrast Tool | WebAIM](http://webaim.org/resources/contrastchecker/)
-   [Accessible Palette Builder | Toolness.github.io](https://toolness.github.io/accessible-color-matrix/)
-   [Contrast Grid | Eightshapes.com](http://contrast-grid.eightshapes.com/?background-colors=&foreground-colors=%23FFFFFF%2C%20White%0D%0A%23F2F2F2%0D%0A%23DDDDDD%0D%0A%23CCCCCC%0D%0A%23888888%0D%0A%23404040%2C%20Charcoal%0D%0A%23000000%2C%20Black%0D%0A%232F78C5%2C%20Effective%20on%20Extremes%0D%0A%230F60B6%2C%20Effective%20on%20Lights%0D%0A%23398EEA%2C%20Ineffective%0D%0A&es-color-form__tile-size=compact)

### Step 4: Add Alternative (alt) Text to Images

Images are a wonderful way to draw attention, build on a story, and provide visual reinforcement to a concept you are trying to explain. However, if your audience has a vision impairment that prevents them from seeing the image clearly or at all, you need to provide a text description of that image. Alternative text, also known as alt text, is descriptive text that conveys the meaning of an image in digital content. When a person uses assistive technology such as a screen reader, the screen reader will read the onscreen text aloud.
...
-   [Authoring Meaningful Alternative Text](https://create/alternative-text/)
...
If you place an image in your signature block, such as the [OIT signature logo](https://www.oit.va.gov/design-guide/resources/logos/), use alt text to convey the meaning of the image. For example, enter ”Department of Veterans Affairs Office of Information and Technology” for the alt text to describe the OIT signature logo.
...
Documents attached to email messages that are public facing or [agency official communication](https://www.section508.gov/tools/glossary/#agency-official-communications) must conform with applicable electronic document standards.
...
-   [Checklist for Accessible Email](https://www.section508.gov/test/checklist/email-messages/)
-   [Minimize Abbreviations | plainlanguage.gov](https://www.plainlanguage.gov/guidelines/words/minimize-abbreviations/)
-   [Keep It Jargon-free | plainlanguage.gov](https://www.plainlanguage.gov/resources/articles/keep-it-jargon-free/)
