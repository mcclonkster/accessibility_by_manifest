---
created: 2026-04-26T13:13:25 (UTC -05:00)
tags: []
source: https://www.w3.org/WAI/standards-guidelines/wcag/non-web-ict/
...
> ## Excerpt
> Introduces the W3C Group Note: Guidance on Applying WCAG 2 to Non-Web Information and Communications Technologies (WCAG2ICT).

---
Page Contents

-   [Introduction](https://www.w3.org/WAI/standards-guidelines/wcag/non-web-ict/#intro)
-   [Background](https://www.w3.org/WAI/standards-guidelines/wcag/non-web-ict/#background)
-   [Intent and usage of WCAG2ICT](https://www.w3.org/WAI/standards-guidelines/wcag/non-web-ict/#intent-and-usage-of-wcag2ict)
-   [Who WCAG2ICT is for](https://www.w3.org/WAI/standards-guidelines/wcag/non-web-ict/#for)
-   [What is in WCAG2ICT](https://www.w3.org/WAI/standards-guidelines/wcag/non-web-ict/#whatis)
-   [What WCAG2ICT does not do](https://www.w3.org/WAI/standards-guidelines/wcag/non-web-ict/#what-wcag2ict-does-not-do)
-   [Who develops WCAG2ICT](https://www.w3.org/WAI/standards-guidelines/wcag/non-web-ict/#wg)
-   [Related documents](https://www.w3.org/WAI/standards-guidelines/wcag/non-web-ict/#related-documents)
...
If it’s not feasible for you to use GitHub, email your comments to: [public-wcag2ict-comments@w3.org](mailto:public-wcag2ict-comments@w3.org). Please put your comments in the body of the message, not as an attachment.

If you have comments on the wording quoted from WCAG 2 or Understanding WCAG 2, follow the [Instructions for Commenting on WCAG 2 Documents](https://www.w3.org/WAI/standards-guidelines/wcag/commenting/).
...
[Back to Top](https://www.w3.org/WAI/standards-guidelines/wcag/non-web-ict/#top)
