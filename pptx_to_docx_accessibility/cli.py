...
from .paths import discover_pptx_files, plan_runs
from .pipeline import DeckResult, run_deck
...
def print_result(result: DeckResult, index: int, total: int) -> None:
    ...
    print(f"\n=== [{index}/{total}] {result.deck.pptx_path} ===")
    print(f"Status: {status}")
    print(f"Message: {result.message}")
    print(f"Output folder: {result.deck.output_dir}")
