...
def render_slide_images(pptx_path: Path, image_dir: Path, config: WorkflowConfig) -> RenderResult:
...
def _render_slide_images(pptx_path: Path, image_dir: Path, config: WorkflowConfig) -> RenderResult:
    ...
    with tempfile.TemporaryDirectory(prefix="pptx_docx_render_") as temp_root:
