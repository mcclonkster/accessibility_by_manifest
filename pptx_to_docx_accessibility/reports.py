...
def write_reports(manifest: Manifest, output_paths: OutputPaths, overwrite: bool) -> None:
    ...
    atomic_write_text(output_paths.remediation_report, build_remediation_report(manifest, output_paths), overwrite)
...
def build_remediation_report(manifest: Manifest, output_paths: OutputPaths) -> str:
    summary = manifest.summary()
