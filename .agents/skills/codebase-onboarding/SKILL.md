...
description: Analyze an unfamiliar codebase and generate a structured onboarding guide with architecture map, key entry points, conventions, and a starter agent instruction file such as AGENTS.md or CLAUDE.md. Use when joining a new project or setting up a coding agent harness for the first time in a repo.
origin: ECC
---

# Codebase Onboarding

Systematically analyze an unfamiliar codebase and produce a structured onboarding guide. Designed for developers joining a new project or setting up Codex, Claude Code, OpenCode, or another coding agent harness in an existing repo for the first time.
...
- User asks to generate an agent instruction file such as AGENTS.md or CLAUDE.md for a project
...
#### Output 2: Starter Agent Instructions

Generate or update a project-specific agent instruction file based on detected conventions. Default to `AGENTS.md` for cross-harness use unless the user explicitly asks for a harness-specific file such as `CLAUDE.md`. If an instruction file already exists, read it first and enhance it; preserve existing project-specific instructions and clearly call out what was added or changed.
...
3. **Respect existing agent instructions** — if `AGENTS.md`, `CLAUDE.md`, or another harness instruction file already exists, enhance it rather than replacing it. Call out what's new vs existing.
...
- Generating an agent instruction file that's longer than 100 lines — keep it focused
...
**Action**: Run full 4-phase workflow -> produce Onboarding Guide + Starter agent instructions
**Output**: Onboarding Guide printed directly to the conversation, plus an `AGENTS.md` written to the project root by default

### Example 2: Generate instructions for existing project
**User**: "Generate an AGENTS.md for this project"
**Action**: Run Phases 1-3, skip Onboarding Guide, produce only the requested instruction file
**Output**: Project-specific `AGENTS.md` with detected conventions

### Example 3: Enhance existing instructions
**User**: "Update the project agent instructions with current project conventions"
**Action**: Read the existing instruction file, run Phases 1-3, merge new findings
**Output**: Updated instruction file with additions clearly marked
