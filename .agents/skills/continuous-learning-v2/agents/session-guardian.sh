...
# Called by observer-loop.sh before spawning any observer agent session.
#
# Config (env vars, all optional):
#   OBSERVER_INTERVAL_SECONDS    default: 300   (per-project cooldown)
#   OBSERVER_LAST_RUN_LOG        default: ~/.agents/observer-last-run.log
...
LOG_PATH="${OBSERVER_LAST_RUN_LOG:-$HOME/.agents/observer-last-run.log}"
