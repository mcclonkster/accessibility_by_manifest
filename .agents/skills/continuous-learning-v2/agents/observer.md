---
name: observer
description: Background agent that analyzes session observations to detect patterns and create instincts. Uses a small/fast model for cost-efficiency. v2.1 adds project-scoped instincts.
model: haiku
---
...
- Project: `<homunculus-dir>/projects/<project-hash>/observations.jsonl`
- Global fallback: `<homunculus-dir>/observations.jsonl`
...
- Project: `<homunculus-dir>/projects/<project-hash>/instincts/personal/`
- Global: `<homunculus-dir>/instincts/personal/` (for universal patterns)
