...
- DAILY skills -> install or keep in the active harness skill directory, such as `.agents/skills/` or `~/.claude/skills/`
...
- `.agents/skills/skill-library/SKILL.md` or the active harness's equivalent skill path
