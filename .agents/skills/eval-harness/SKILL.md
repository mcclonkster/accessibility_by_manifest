---
name: eval-harness
description: Formal evaluation framework for coding agent sessions implementing eval-driven development (EDD) principles
origin: ECC
...
A formal evaluation framework for Codex, Claude Code, OpenCode, and other coding agent sessions, implementing eval-driven development (EDD) principles.

## When to Activate

- Setting up eval-driven development (EDD) for AI-assisted workflows
- Defining pass/fail criteria for coding agent task completion
...
```
Creates eval definition file at `.agents/evals/feature-name.md` or the harness-specific eval path.
