...
- Coordinating work across Codex, Claude Code, OpenCode, and other harnesses
...
- Supports: Codex, Claude Code, OpenCode, Cline, Gemini, Qwen
...
Pane 3 (OpenCode): "Write E2E tests for the checkout flow"
```
...
# Pane 2: cd ../feature-billing && opencode
...
| **Harness-native subagents** | In-process subagent spawning | Programmatic parallelism within a session |
...
```json
{
  ...
  "seedPaths": [
    ...
    ".agents/plan/workflow-e2e-test.json"
  ],
