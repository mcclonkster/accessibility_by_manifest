...
- AI agent (Codex, Claude Code, OpenCode, Cursor, or similar) has modified API routes or backend logic
...
```markdown
<!-- .agents/commands/bug-check.md or the harness-specific command path -->
# Bug Check
